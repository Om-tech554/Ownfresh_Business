...
const Navbar = () => {
    ...
    const [announcement, setAnnouncement] = useState("🎉 FREE SHIPPING ON ORDERS ABOVE ₹1500 • 🌿 PREMIUM GRADE PURE OIL & STONE PRESSED BOTANIC OILS • 👑 JOIN PRIME 1% FOR 10% OFF MRPS & REWARD COINS (3 MONTHS) • 📦 EXPRESS 2-DAY DELIVERY ACROSS INDIA");
