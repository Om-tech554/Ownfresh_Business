  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[#0B0F14] py-16 px-6 md:px-20 text-gray-700 dark:text-[#B7C1CE] relative transition-colors duration-200">
      ...
      >
        ...
        <h1 className="text-3xl md:text-4xl font-black text-black dark:text-[#F7F9FC] mb-2 text-center">Return, Refund & Cancellation Policy</h1>
        ...
        <div className="space-y-6 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-black dark:text-[#F7F9FC] mb-3">1. Return Window</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-black dark:text-[#F7F9FC] mb-3">2. Eligibility for Return</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-black dark:text-[#F7F9FC] mb-3">3. Return Approval</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-black dark:text-[#F7F9FC] mb-3">4. Upon Successful Return</h2>
            ...
            <ul className="list-disc list-inside space-y-1.5 ml-4">
              ...
              <p className="ml-6 text-gray-500 dark:text-[#818C9B] font-bold uppercase tracking-wider text-[10px] my-1">OR</p>
              <li>An exchange for the same or an equivalent product, subject to stock availability.</li>
            </ul>
          </section>

          <section>
            <h2 className="text-xl font-bold text-black dark:text-[#F7F9FC] mb-3">5. Refund Timeline</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-black dark:text-[#F7F9FC] mb-3">6. Exchange Timeline</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-black dark:text-[#F7F9FC] mb-3">7. Non-Returnable Items</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-black dark:text-[#F7F9FC] mb-3">8. Cancellation Policy</h2>
            <p>
          ...
          <section className="pt-6 border-t border-gray-100 dark:border-[#202832]">
            ...
            <div className="mt-6 p-6 bg-amber-50 dark:bg-[#151B23] rounded-2xl border border-amber-100/50 dark:border-[#27313D] text-center flex flex-col items-center">
              <h3 className="font-bold text-black dark:text-[#F7F9FC] text-lg">Have an issue with your order?</h3>
              <p className="text-xs text-gray-600 dark:text-[#B7C1CE] mt-1 max-w-md">
                If you received a damaged, wrong, or incomplete order, you can raise a formal support ticket here.
              </p>
              <button
                onClick={() => setIsTicketModalOpen(true)}
                className="mt-4 px-6 py-2.5 bg-gray-900 dark:bg-[#FFD600] text-white dark:text-[#101318] hover:bg-yellow-500 dark:hover:bg-[#FFE45C] hover:text-black transition-colors rounded-xl font-bold text-sm tracking-wide shadow-xs cursor-pointer border-0"
              >
